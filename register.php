        ...
        <div class="w-50 h-75 flex-center p-3 column">
            ...
            <form action="" class="w-50">
                <div class="column flex-center w-100">
                    <input type="text" placeholder="Name" class="round-5    light bg-dark-blue my-2 py-2 px-3 w-100">
                    <input type="text" placeholder="Phone number" class="round-5 light bg-dark-blue my-2 py-2 px-3 w-100">
                    ...
                    <button class="round-5 mt-4 mb-2 p-2 w-50 bg-light-blue">Daftar</button>
                </div>
            </form>
            <div>
